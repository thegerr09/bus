...
function clear_form(id) {
  ...
  form.find('[name]').val('');
  form.attr('action', '{{ url('Jurnal/input') }}');
  viewJurnal();
  if (id == 1) {
    $('#Tambah').modal('hide');
