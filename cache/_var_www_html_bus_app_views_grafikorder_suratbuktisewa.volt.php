      ...
      <div style="width: 47%; float: left; padding-left: 30px;">
        ...
        <table border="0" style="font-size: 11px;">
          <tr>
            <td>Nama Pemesan</td>
            <td>:</td>
            <td colspan="2"><?= Phalcon\Text::upper($booking->nama) ?></td>
          </tr>
          <tr>
            <td>Nomor Telpon</td>
            <td>:</td>
            <td colspan="2"><?= Phalcon\Text::upper($booking->telpon) ?></td>
          </tr>
          <tr>
            ...
            <?php if ($booking->paket == 'regular') { ?>
              <?= $this->Prints->TujuanRegular($booking->route, $booking->lokasi) ?>
            <?php } else { ?>
            <?php } ?>
            </td>
          </tr>
          <tr>
            <td>Berangkat Tgl</td>
            <td>:</td>
            <td colspan="2"><?= Phalcon\Text::upper($booking->tanggal_mulai) ?></td>
          </tr>
          <tr>
            <td>Jumlah Armada</td>
            <td>:</td>
            <td colspan="2"> <?= $this->Prints->BusCount($booking->nama, 'big', $booking->tanggal_mulai) ?> Besar | <?= $this->Prints->BusCount($booking->nama, 'medium', $booking->tanggal_mulai) ?> Medium</td>
          </tr>
          <tr>
            <td>Kode Booking Bus</td>
            <td>:</td>
            <td colspan="2"> <?= $this->Prints->KodeBooking($booking->nama, $booking->tanggal_mulai) ?></td>
          </tr>
          <tr>
            <td>Biaya Sewa</td>
            <td>:</td>
            <td colspan="2">Rp. <?= $this->Helpers->number($booking->tarif) ?>,-</td>
          </tr>
          <tr>
            <td>Uang Muka</td>
            <td>:</td>
            <td>Rp. <?= $this->Helpers->number($booking->dp) ?>,-<td>
          </tr>
          <tr>
            <td>Sisa</td>
            <td>:</td>
            <td>Rp.<?php $sisa = $booking->tarif - $booking->dp; ?> <?= $this->Helpers->number($sisa) ?>,-<td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center"><b><?= Phalcon\Text::upper($booking->nama) ?></b></td>
            <td></td>
            <td></td>
            <td align="center">.................................</td>
          </tr>
