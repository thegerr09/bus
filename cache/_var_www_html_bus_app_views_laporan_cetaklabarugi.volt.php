  ...
  <div>
    ...
    <table style="border-collapse: collapse;" width="100%" id="table" cellpadding="5">
      ...
      <tr>
        ...
        <td>Rp.<span style="float:right;"><?= $this->Helpers->number($pendapatan) ?> ,-</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Rp.<span style="float:right;"><?= $this->Helpers->number($pengeluaran) ?> ,-</span></td>
      </tr>
      <?php $total = $pendapatan - $pengeluaran; ?>
      <tr>
        ...
        <td><b>Rp.<span style="float:right;"><?= $this->Helpers->number($total) ?> ,-</span></b></td>
      </tr>
    </table>
  </div>
