...
<body style="font-family:Tahoma, Geneva, Verdana, sans-serif;" onload="windows:print()">
  ...
  <table style="border-collapse: collapse;" width="100%" cellpadding="5">
    ...
    <?php $no = 1; ?>
    <?php foreach ($jurnalChild as $x) { ?>
    <?php if ($x->id_jurnal == $jurnal->id) { ?>
    <tr>
      <td style="border: 1px solid black;"><?= $no ?></td>
      <td style="border: 1px solid black;"><?= $this->Prints->account($x->account)->account ?></td>
      <td style="border: 1px solid black;">Rp.<span style="float:right;"><?= $this->Helpers->number($x->debet) ?> ,-</span></td>
      <td style="border: 1px solid black;">Rp.<span style="float:right;"><?= $this->Helpers->number($x->kredit) ?> ,-</span></td>
    </tr>
    <?php $no = $no + 1; ?>
    <?php } ?>
    <?php } ?>
    <tr>
      ...
      <td style="border: 1px solid black;">Rp.<span style="float:right;"><?= $this->Helpers->number($jurnal->total_debet) ?> ,-</span></td>
      <td style="border: 1px solid black;">Rp.<span style="float:right;"><?= $this->Helpers->number($jurnal->total_kredit) ?> ,-</span></td>
    </tr>
  </table>
  </div>
