...
<body style="font-family:Tahoma, Geneva, Verdana, sans-serif;" onload="windows:print()">
  ...
  <center><h2>PRINT LIST JURNAL<br><small><?= $this->Helpers->dateChange($dt[0]) ?> - <?= $this->Helpers->dateChange($dt[1]) ?></small></h2></center>
  <p></p>
  <table style="border-collapse: collapse;" width="100%" cellpadding="5">
    ...
    <tr>
      ...
      <td style="border: 1px solid black;"><?= $this->Helpers->dateChange($x->tanggal) ?></td>
