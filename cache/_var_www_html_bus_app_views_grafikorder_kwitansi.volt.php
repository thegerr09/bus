      ...
      <table border="0">
        ...
        <tbody>
          <tr>
            ...
            <td rowspan="2" colspan="2"> <?= Phalcon\Text::upper($invoice->nama) ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="5px" rowspan="2">:</td>
            <td colspan="2"><div style="width: 200px; border:2px solid black;">Rp.  <?= $this->Helpers->number($invoice->tarif) ?>,-</div></td>
          </tr>
          <tr>
